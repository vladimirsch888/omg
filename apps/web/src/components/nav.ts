...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/reports/retention", label: "Удержание", icon: Repeat },
    ],
  },
  {
